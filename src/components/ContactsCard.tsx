    ...
    return (
        <div className='py-8 px-16  bg-[#2A3047] text-[#E7EAF0]'>
            ...
            <div className='flex items-center sm:items-start'>
                ...
                </svg><div className='text-[#E7EAF0] ml-2 sm:text-[#E8EBF3]'>{address}.</div>
            </div>
            <div className='text-white opacity-60 sm:opacity-100 sm:text-[#E8EBF3]'>{phone},</div>
            <div className='text-white opacity-60 sm:opacity-100 sm:text-[#E8EBF3]'>{email}</div>
        </div>
    )
}